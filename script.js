...
const segments = [
    ...
    },
    {
        ...
        subtitle:
            "Обслуживание залов ожидания терминалов A, D и B в аэропорту Внуково.",
    ...
    },
    {
        ...
        subtitle:
            "Короткий маршрут вдоль ул. Академика Анохина между домами 50, 60 и 66.",
    ...
    },
    {
        ...
        subtitle:
            "Прогулочный маршрут по главной аллее Поклонной горы: Аллея Связистов – Музей Великой Отечественной войны – Аллея Артиллеристов.",
    ...
    },
    {
        ...
        subtitle:
            "Внутренний маршрут по территории вокзала: от площади Киевского вокзала через залы ожидания №1, 2, 3 к платформам поездов дальнего следования.",
    ...
    },
    {
        ...
        subtitle:
            "От автопарка (Проектируемый проезд 133) через КПП №1 (Проектируемый проезд 139) к ул. Героя РФ Соломатина.",
    ...
    },
    {
        ...
        subtitle:
            "От Проектируемого проезда 139 через КПП №2 войсковой части 61899 к Музыкальному проезду.",
